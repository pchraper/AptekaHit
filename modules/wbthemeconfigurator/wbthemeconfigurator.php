...
class WbThemeConfigurator extends Module
{
    ...
    public function hookdisplayHeader()
    {
        ...
        $this->context->controller->addCss($this->_path.'views/css/frontend/nivo-slider.css');
        $this->context->controller->addCss($this->_path.'views/css/frontend/bootstrap-select.min.css');
        ...
        $this->context->controller->addJs($this->_path.'views/js/frontend/bootstrap-select.min.js');
        $this->context->controller->addJs($this->_path.'views/js/frontend/jquery.nivo.slider.js');
        $this->context->controller->addJs($this->_path.'views/js/frontend/jquery.nivo.slider.pack.js');
