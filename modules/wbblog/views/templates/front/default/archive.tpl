...
{block name="page_content_container"}
	...
	<div class="kr_blog_post_area undblg">
		...
		<div class="row">
			{foreach from=$wbblogpost item=xpblgpst}
				...
				<article id="blog_post" class="archb blog_post_{$xpblgpst.post_format} col-md-4 col-xs-12 col-sm-6">
						<div class="blogbg">
						...
						<div class="blog_post_content_bottom allbl">
							...
							<h3 class="post_title"><a href="{$xpblgpst.link}">{$xpblgpst.post_title|truncate:70:'...'}</a></h3>
							<div class="blogdl"><span>{$xpblgpst.post_author_arr.firstname} {$xpblgpst.post_author_arr.lastname}</span> <sup>*</sup>
									<span>{$xpblgpst.post_date|date_format:"%b %dth, %Y"}</span></div>
