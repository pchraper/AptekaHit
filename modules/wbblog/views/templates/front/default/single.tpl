...
<div class="row">
	<section id="content" class="col-xs-12 col-lg-6 col-md-6 stickyb">
					...
					<div class="blog_post_content">
						<div class="blog_post_content_top">
							<div class="post_thumbnail">
								...
								{else}
									<img class="wbblog_img img-responsive center-block" src="{$wbblogpost.post_img_large}" alt="{$wbblogpost.post_title}">
								{/if}
							</div>
						</div>
						...
						<div class="blog_post_content_bottom allbl">
							<div class="post_metas clearfix">
								...
								<li class="meta_category hidden-sm-down">
									...
									<span>{$wbblogpost.category_def_arr.name}</span>
								</li>
