      ...
      {elseif $field.type === 'checkbox'}
        ...
        {block name='form_field_item_checkbox'}
          <span class="custom-checkbox">
            <div class="col-xs-2 col-sm-2"><input name="{$field.name}" type="checkbox" value="1" {if $field.value}checked="checked"{/if} {if $field.required}required{/if}>
            <span><i class="material-icons checkbox-checked">&#xE5CA;</i></span></div>
            <div class="col-xs-10 col-sm-10"><label>{$field.label nofilter}</label></div>
          </span>
        {/block}
