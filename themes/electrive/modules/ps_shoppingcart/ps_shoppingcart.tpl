  ...
  <div class="blockcart cart-preview {if $cart.products_count > 0}active{else}inactive{/if}" data-refresh-url="{$refresh_url}">
    <div class="header">
      ...
      <div class="hcart d-inline-block" data-toggle="dropdown">
        <div class="d-inline-block sbg"><svg width="32px" height="32px"><use xlink:href="#hcart"></use></svg><span class="carti"><span>{$cart.products_count}</span></div><div class="hdis text-xs-left">
