          ...
          <div class="col-xs-12 divide-right">
            <div class="">
              ...
              <div class="col-sm-8 col-xs-12 lc">
                ...
                <div class="modprice">{$product.price}</div>
        ...
        <div class="col-xs-12 cart-content">
            <div>
              {if $cart.products_count > 1}
                <span class="cart-products-count"><svg width="25px" height="25px"> <use xlink:href="#hcart"></use></svg> {l s='There are %products_count% items in your cart.' sprintf=['%products_count%' => $cart.products_count] d='Shop.Theme.Checkout'}</span>
              {else}
             ...
             {*  {if $cart.subtotals.tax}
              ...
              <div class="cart-content-btn">
                <button type="button" class="btn btn-block btn-primary" data-dismiss="modal">{l s='Continue' d='Shop.Theme.Actions'}</button>&nbsp;&nbsp;
                <a href="{$cart_url}" class="btn btn-block btn-primary">{l s='checkout' d='Shop.Theme.Actions'}</a>
              </div>
            </div>
          </div>
      </div>
