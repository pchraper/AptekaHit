...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62037edbc06b09_98068961',
...
function content_62037edbc06b09_98068961 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->smarty->ext->_tplFunction->registerTplFunctions($_smarty_tpl, array (
  'menu' => 
  array (
    'compiled_filepath' => 'D:\\xampp\\htdocs\\aptekahit_sklep\\var\\cache\\prod\\smarty\\compile\\bizkick\\41\\df\\19\\41df1985130dffd7d3fe4cb369091546a0b40be7_2.module.psmainmenupsmainmenu.tpl.php',
    'uid' => '41df1985130dffd7d3fe4cb369091546a0b40be7',
    'call_name' => 'smarty_template_function_menu_50064458162037edbbf2588_35722700',
  ),
));
...
/* smarty_template_function_menu_50064458162037edbbf2588_35722700 */
if (!function_exists('smarty_template_function_menu_50064458162037edbbf2588_35722700')) {
function smarty_template_function_menu_50064458162037edbbf2588_35722700(Smarty_Internal_Template $_smarty_tpl,$params) {
...
?>
                <li class="classic-list <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['node']->value['type'], ENT_QUOTES, 'UTF-8');
if ($_smarty_tpl->tpl_vars['node']->value['current']) {?> current <?php }?> <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?> has-child <?php }?> level<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['depth']->value, ENT_QUOTES, 'UTF-8');?>
...
" data-toggle="collapse" class="navbar-toggler collapse-icons">
                    ...
                    <?php if (count($_smarty_tpl->tpl_vars['node']->value['children'])) {?>
                        <div <?php if ($_smarty_tpl->tpl_vars['depth']->value === 0) {?> class="classic-menu popover sub-menu js-sub-menu collapse"<?php } else { ?> class="collapse"<?php }?> id="top_sub_menu_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_expand_id']->value, ENT_QUOTES, 'UTF-8');?>
">
                            ...
                            <?php if (count($_smarty_tpl->tpl_vars['node']->value['image_urls']) > 0) {?>
                                <div class="cat-bottom-block" data-count="<?php echo htmlspecialchars(count($_smarty_tpl->tpl_vars['node']->value['children']), ENT_QUOTES, 'UTF-8');?>
">
                                    <?php
